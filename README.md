...
**Full Stack & GenAI Engineer.** Building, breaking, and shipping.
...
I build production-minded AI systems - safety middleware, developer tools, and the infrastructure that holds them together.
...
- Contributed to **[OmegaUp](https://omegaup.com)**, shipping the Profile READMEs feature end-to-end across the database

Currently working on **GPU compute infrastructure**, **inference scheduling systems**, and **multilingual voice agents**.
